    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Enter the title of the contest.', max_length=150)),
                ('slug', models.SlugField(blank=True, help_text="Slug that appears in the url. If not provided, 'title' will be used instead", null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news_agreement', models.BooleanField(default=True, help_text='Do you want to receive e-mails from us? e.g: info about new contests')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Enter the title of the work.', max_length=100)),
