    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(help_text='The start date of the contest.')),
                ('end_date', models.DateTimeField(help_text='The end date of the contest.')),
                ('publish_date', models.DateTimeField(help_text='The date when results will be published.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_receiver', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='contest_app.contestmodel')),
            ],
            options={
