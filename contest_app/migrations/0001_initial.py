...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_img', models.ImageField(blank=True, help_text='Your profile picture. .jpg, .jpeg, .png only!', null=True, upload_to=contest_app.models.ProfileModel.user_directory_path)),
