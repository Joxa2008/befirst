...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='experts',
            field=models.ManyToManyField(help_text='Select experts for the contest.', related_name='contests', to='contest_app.expertmodel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='profilemodel',
            name='region',
            field=models.ForeignKey(help_text="Choose a region you reside. e.g. 'Samarkand'", on_delete=django.db.models.deletion.CASCADE, to='contest_app.region'),
        ),
        migrations.AddField(
